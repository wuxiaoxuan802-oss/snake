...
function generateFood() {
    ...
    while (collision) {
        ...
        // 檢查是否與蛇身重疊
        const onSnake = snake.some(part => part.x === newX && part.y === newY);
        // 檢查是否與現有食物重疊
        const onFood = foods.some(f => f.x === newX && f.y === newY);

        collision = onSnake || onFood;
    }
